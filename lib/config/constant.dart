...
class Constant {
  ...
  static Color? custDarkGray = Color(0xFF494949);
  static Color? custYellow = const Color(0xFFFFF0DB);
  static Color? custNaviBlue = const Color(0xFF24269B);
  static Color? custDrakBlue = const Color(0xFF474768);
  static Color? custLightBlue = const Color(0xFFCBECF1);
  static Color? custBorSha = const Color(0xFFDCDCDC);
